...
function transform(html, options) {
  const tempPath = (0, import_path.resolve)(__dirname, "../src/temp.html");
  const tempContent = (0, import_lodash.template)((0, import_fs.readFileSync)(tempPath, "utf-8"))(options);
...
var MyHtmlWebpackPlugin = class {
  constructor(options) {
    this.options = {};
    this.options = (0, import_lodash2.merge)({
      interval: 1e3,
      beforeHtml: null,
      afterHtml: null,
      enable: true
